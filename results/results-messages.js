...
export const socialMessages = {
    ...
    mid: 'You have gained some recognition of your cause, and some people may even support you, but you have a long way to go before you gain rights for robot kind. Looking ahead you see a long and hard road, but you are determined to make the world a better place for robots everywhere.',
...
export const itemMessages = {
    noItems: 'It\'s been a long road with little show for it.',
    items: 'On your journey you gained more than you had planned for! You\'ve obtained ______. Great job!'
};